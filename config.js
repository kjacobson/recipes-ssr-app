...
module.exports = {
    ...
    external_port: process.env.EXTERNAL_PORT ? parseInt(process.env.EXTERNAL_PORT, 10) : undefined,
    external_host: process.env.EXTERNAL_HOST || "localhost",
    protocol: process.env.PROTOCOL || 'http',
    api : {
        host: process.env.API_HOST || "localhost",
        port: process.env.API_PORT ? parseInt(process.env.API_PORT, 10) : 3004,
